  ...
  return (
    <div className="min-h-screen text-white font-sans flex flex-col">
      ...
      <div className="flex-1 p-4 flex flex-col items-center justify-center">
        <div className="relative w-full max-w-2xl border-2 border-[#56ab91] rounded-3xl bg-slate-900/60 p-8 shadow-2xl backdrop-blur-sm">
          
          {!showGalleryModal && (
            <button 
              onClick={() => setPantalla('perfil')}
              className="absolute top-4 right-4 w-10 h-10 bg-[#2d2a3e] rounded-full flex items-center justify-center font-bold border border-[#56ab91] hover:bg-red-600 transition-all z-10"
            >
              X
            </button>
          )}
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex gap-4 items-end">
              <div className="flex-[4]">
                <label className="block text-sm font-bold mb-1 ml-1 tracking-tight">Título</label>
                <input 
                  type="text" 
              ...
              <div className="flex-1">
                <label className="block text-sm font-bold mb-1 ml-1 tracking-tight">Cantidad</label>
                <input 
                  type="number" 
            ...
            {tipoPublicacion === 'venta' && (
              <div>
                <label className="block text-sm font-bold mb-1 ml-1 tracking-tight">Precio</label>
                <input 
                  type="number" 
                  className="w-full bg-transparent border-2 border-dashed border-[#56ab91]/60 rounded-2xl py-2 px-4 outline-none focus:border-emerald-400"
                  placeholder="$0.00"
