...
const Feed = () => {
  ...
  const cards = [
    { id: 1, type: "Carta Holo", fandom: "Pokémon", fandomId: "pokemon", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlSLVcEaKMsGAkeA35IbD9_cFuXXEdATuzfQ&s/200x280", reverse: "Edición Limitada", description: "bonita", price: "$25.00", isVenta: true, isIntercambio: false, isColeccion: false },
    { id: 2, type: "Carta Normal", fandom: "Magic", fandomId: "magic", image: "https://gatherer.wizards.com/Handlers/Image.ashx?type=card&name=Shadowmage+Infiltrator/200x280", reverse: "Foil", description: "linda", price: "$350.00", isVenta: true, isIntercambio: true, isColeccion: false },
    { id: 3, type: "Carta Rara", fandom: "Digimon", fandomId: "digimon", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgZ856cXwx7YgoNnyCXZyIZrCx9-RoLsijJg&s/200x280", reverse: "Alternativa", description: "wow", price: "$45.00", isVenta: false, isIntercambio: true, isColeccion: false },
    { id: 4, type: "Carta Promo", fandom: "DragonBall", fandomId: "dragonball", image: "https://mnacardz.com/cdn/shop/files/BT26-139_SCR_Metamorphic_Android_Cell_2024_124538ed-f4f5-4a0c-8428-5e7362738238.jpg?v=1753904845&width=3024/200x280", reverse: "Holo", description: "muy especial", price: "$30.00", isVenta: true, isIntercambio: false, isColeccion: false },
  ];
