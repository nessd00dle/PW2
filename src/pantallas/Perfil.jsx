...
import '../App.css'
import './index.css'
import { Toggle } from '../componentes/Modos/toggle';
...
const Perfil = ({ setPantalla }) => {
  ...
  return (
    <div className="min-h-screen font-windows p-4 overflow-x-hidden">
      {/* navbar */}
      <div className='App' data-theme={isDark ? "dark" : "light"}>
        ...
        {/* header perfil */}
        <div className="border-2 border rounded-[30px] p-8 mb-8 relative bg-slate">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p>Fecha de registro: 04/02/26</p>
              <p className="highlight">Colección: {cartasMostrar.length} cartas</p>
              <p className="max-w-md italic">Coleccionista apasionado de cartas, siempre buscando nuevas adquisiciones para mi colección.</p>

              <div className="mt-6 flex gap-4 justify-center md:justify-start">
                <button
                  onClick={() => setPantalla('auth')}
                  className="button px-4 py-2 rounded-lg text-sm hover:bg-slate-700 transition-all text-red-400"
                >
                  Cerrar sesión
                </button>
              </div>
        ...
        <div className="fixed bottom-6 right-6 flex flex-col gap-3">
          <button
            onClick={() => setPantalla('publicar')}
            className="button p-3 rounded-full shadow-lg border-2 border-[#56ab91]  transition-all flex items-center justify-center w-14 h-14 group"
          >
            <img
          ...
          <button
            ...
            className="button p-3 rounded-full shadow-lg border-2 border-[#56ab91] hover:bg-emerald-800 transition-all flex items-center justify-center w-14 h-14 group"
          >
            <img
