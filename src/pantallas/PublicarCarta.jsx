    ...
    <div className="min-h-screen bg-[#0f172a] text-white font-sans p-4 flex flex-col items-center">
      ...
      <div className="relative w-full max-w-2xl border-2 border-[#56ab91] rounded-3xl bg-slate-900/40 p-10 shadow-2xl">
        ...
        <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
          ...
          {/* foto carta */}
          <div className="w-full h-40 border-2 border-dashed border-[#56ab91]/60 rounded-3xl flex items-center justify-center bg-slate-800/10 hover:bg-slate-800/20 transition-all cursor-pointer">
            <div className="bg-[#4d5b61] px-6 py-2 rounded-xl border border-slate-500 shadow-lg group">
              <span className="text-gray-200 font-bold text-xs uppercase tracking-wide group-hover:text-white">Agregar fotos</span>
            </div>
          </div>
